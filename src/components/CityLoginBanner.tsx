      ...
      <div className="city-login-banner-inner-centered">
        ...
        <div className="city-login-banner-text-centered">
          <p className="city-login-banner-headline">
            <span className="stop-hunting-icon"><Mail size={18} />Stop hunting for events.</span> Get them delivered <span className="monday-with-icon"><Mail size={18} />every Monday</span> - Free, No account needed
          </p>
        </div>
      </div>
    </div>
