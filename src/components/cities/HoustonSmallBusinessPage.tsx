...
function HoustonSmallBusinessContent() {
    ...
    <div className="sa-page">
      ...
      <section className="why-section">
        <div className="why-inner">
          <h2>Houston's Small Business Community</h2>
      ...
      <section className="sa-calendar-section" id="calendar">
        ...
        <EventGate forcedCity="Houston" eventCategory="small_business" />
      </section>
      ...
      <section className="sa-subscribe-section" id="sa-subscribe">
        <div className="sa-subscribe-inner">
          ...
          <p>Get Houston's best small business events delivered to your inbox every Monday morning. No spam, no fluff — just the events worth your time.</p>
...
export function HoustonSmallBusinessPage() {
  return <HoustonSmallBusinessContent />;
}
