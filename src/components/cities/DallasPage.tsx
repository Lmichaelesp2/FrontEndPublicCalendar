...
const FAQ_ITEMS = [
  {
    ...
    answer: 'Yes! The Dallas calendar and weekly email are completely free — no credit card required. The full calendar is free and open to everyone. Give us your email and we deliver every upcoming event straight to your inbox every Monday morning.',
  },
  {
            ...
            <div className="hero-city-panel">
              ...
              <ul className="hero-city-panel-list">
                {['Chamber', 'Technology', 'Real Estate', 'Small Business', 'and many more'].map((tag) => {
                  ...
                  const href = (SUB_CALENDARS_ENABLED && slug[tag as keyof typeof slug]) ? `/texas/dallas/${slug[tag as keyof typeof slug]}` : null; // SUB-CAL: hidden while paused
                  return (
...
<section className="features-section">
        <div className="features-inner">
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <h3>Sign up free</h3>
              <p>Enter your email and get the Monday newsletter — the week\'s top Dallas business events delivered to your inbox. No credit card, no setup.</p>
            </div>
            <div className="feature-card">
              <div className="feature-step">2</div>
              <h3>Browse the calendar</h3>
              <p>The calendar is always open. Check back anytime to see what\'s happening in Dallas this week.</p>
            </div>
            <div className="feature-card">
      ...
      <section className="sa-subscribe-section" id="dallas-subscribe">
        <div className="sa-subscribe-inner">
          ...
          <p>Get Dallas business events delivered to your inbox every Monday — free, no account needed.</p>
          <div className="sa-subscribe-actions">
            <Link href="/texas/dallas/subscribe" className="btn btn-primary">Subscribe Free — Get the Full Week</Link>
          </div>
        </div>
      </section>
