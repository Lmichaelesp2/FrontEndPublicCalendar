  ...
  return (
    <div className="sa-page">
      ...
      <WhySection
        ...
        problemText="Business events in Dallas are scattered across Eventbrite, Meetup, LinkedIn, Facebook, chambers, and association websites. Most professionals miss events simply because they didn't know they were happening."
        whatWeDoText="We track business event hosts across Dallas and organize their public events into one city-focused calendar — updated every week."
      ...
      <section className="sa-subscribe-section" id="dallas-subscribe">
        <div className="sa-subscribe-inner">
          ...
          <div className="sa-subscribe-actions">
            ...
            <Link href="/texas/dallas/subscribe" className="btn btn-gold">Sign Up Free — Unlock the Full Week + Newsletter</Link>
          </div>
          <p className="sa-subscribe-note">Work across multiple Texas cities? <Link href="/texas/san-antonio">San Antonio</Link>, <Link href="/texas/austin">Austin</Link>, and <Link href="/texas/houston">Houston</Link> are free too.</p>
        </div>
      </section>
