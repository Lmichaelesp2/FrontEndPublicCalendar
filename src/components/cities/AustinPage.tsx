...
const STATS = [
  { number: '150+', label: 'Events added monthly' },
  { number: '1,200+', label: 'Austin professionals subscribed' },
  { number: '200+', label: 'Austin business organizations tracked' },
];
    ...
    <div className="sa-page">
      ...
      <section className="features-section">
        <div className="features-inner">
          ...
          <p className="features-subtitle">We aggregate sources across Austin so you don't have to — then deliver the best event opportunities straight to your inbox every Monday.</p>
          ...
          <div className="features-grid">
            ...
            <div className="feature-card">
              ...
              <p>The calendar shows today's events to everyone. Sign up free and instantly see everything happening this week in Austin — all event types, all days.</p>
            </div>

            <div className="feature-card">
              <div className="feature-step">3</div>
              <h3>Get your Monday newsletter</h3>
              <p>Every Monday morning, a curated digest of that week's best business and networking events in Austin lands in your inbox. We do the research — you show up.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="why-section">
        <div className="why-inner">
          <h2>Why Austin Professionals Use This Calendar</h2>
          <p className="why-subtitle">Most Austin professionals miss events because they're scattered across multiple platforms and websites. We bring them together in one city-focused calendar — updated weekly.</p>
          <div className="why-grid">
            <div className="why-card">
              <h3>The problem</h3>
              <p>Business events in Austin are scattered across Eventbrite, Meetup, LinkedIn, Facebook, chambers, and association websites. Most professionals miss events simply because they didn't know they were happening.</p>
            </div>
            <div className="why-card">
              <h3>What we do</h3>
              <p>We track business event hosts across Austin and organize their public events into one city-focused calendar — updated every week.</p>
            </div>
            <div className="why-card">
              <h3>What you get</h3>
        ...
        <div className="value-inner">
          ...
          <div className="value-grid">
            <div className="value-card">
              ...
              <p>The calendar shows today's business and networking events in Austin to everyone — no signup needed. Come back anytime.</p>
            </div>
            <div className="value-card">
              <div className="value-icon"><Search size={40} strokeWidth={2} /></div>
              <h3>Sign up to unlock the full week</h3>
              <p>Free signup gives you access to the entire week of upcoming events in Austin, not just today. See what's happening Monday through Sunday and plan ahead.</p>
            </div>
            <div className="value-card">
...
export function AustinPage() {
  return <AustinContent />;
}
