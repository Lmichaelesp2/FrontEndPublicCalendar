...
const TECH_STATS = [
  ...
  { number: '3,000+', label: 'Tech professionals subscribed' },
...
function HoustonTechnologyContent() {
    ...
    <div className="sa-page">
      ...
      <section className="why-section">
        <div className="why-inner">
          <h2>Houston's Technology Community</h2>
      ...
      <section className="sa-calendar-section" id="calendar">
        ...
        <EventGate forcedCity="Houston" eventCategory="technology" />
      </section>
      ...
      <section className="sa-subscribe-section" id="sa-subscribe">
        <div className="sa-subscribe-inner">
          ...
          <p>Get Houston's best technology events delivered to your inbox every Monday morning. No spam, no fluff — just the events worth your time.</p>
...
export function HoustonTechnologyPage() {
  return <HoustonTechnologyContent />;
}
