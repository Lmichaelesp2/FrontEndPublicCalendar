      ...
      <Breadcrumb items={[
        ...
        <div className="se-hero-inner">
          ...
          <p className="hero-sub">
            Investor meetups, agent networking events, property tours, and real estate luncheons — Austin real estate events tracked and delivered every week.
          </p>
          ...
          <div className="hero-cta-group">
            <Link href="/texas/austin/real-estate/subscribe" className="btn btn-primary">
              Get the Free Austin Real Estate Events Newsletter
            </Link>
        ...
        <div className="features-inner">
          ...
          <div className="features-grid">
            ...
            <div className="feature-card">
              ...
              <p>Every Monday, get a curated digest of that week's top Austin real estate events.</p>
            </div>
            <div className="feature-card">
      ...
      <section className="sa-subscribe-section" id="sa-subscribe">
        <div className="sa-subscribe-inner">
          ...
          <div className="sa-subscribe-actions">
            <Link href="/texas/austin/real-estate/subscribe" className="btn btn-primary">Get the Weekly Newsletter — Free</Link>
          </div>
