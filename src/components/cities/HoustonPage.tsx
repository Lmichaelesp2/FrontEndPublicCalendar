  ...
  return (
    <div className="sa-page">
      ...
      <WhySection
        ...
        problemText="Business events in Houston are scattered across Eventbrite, Meetup, LinkedIn, Facebook, chambers, and association websites. Most professionals miss events simply because they didn't know they were happening."
        whatWeDoText="We track business event hosts across Houston and organize their public events into one city-focused calendar — updated every week."
        ...
        <div className="value-inner">
          ...
          <div className="value-grid">
            <div className="value-card">
              ...
              <p>The calendar shows today's business and networking events in Houston to everyone — no signup needed. Come back anytime.</p>
            </div>
            <div className="value-card">
              <div className="value-icon"><Search size={40} strokeWidth={2} /></div>
              <h3>Sign up to unlock the full week</h3>
              <p>Free signup gives you access to the entire week of upcoming events in Houston, not just today. See what's happening Monday through Sunday and plan ahead.</p>
            </div>
            <div className="value-card">
      ...
      <section className="city-categories-section">
        <div className="city-categories-inner">
          <h2>Browse Houston Events by Category</h2>
          <p className="city-categories-subtitle">Explore Houston's business event scene by topic</p>
      ...
      <section className="sa-subscribe-section" id="houston-subscribe">
        <div className="sa-subscribe-inner">
          ...
          <p>Get the full week's Houston events delivered to your inbox every Monday morning. No spam, no fluff — just the events worth your time.</p>
          <div className="sa-subscribe-actions">
            <Link href="/submit" className="btn sa-btn-outline">Submit an Event</Link>
            <Link href="/texas/houston/subscribe" className="btn btn-gold">Sign Up Free — Unlock the Full Week + Newsletter</Link>
          </div>
          <p className="sa-subscribe-note">Work across multiple Texas cities? <Link href="/texas/san-antonio">San Antonio</Link>, <Link href="/texas/austin">Austin</Link>, and <Link href="/texas/dallas">Dallas</Link> are free too.</p>
        </div>
      </section>
