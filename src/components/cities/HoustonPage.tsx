            ...
            <div className="hero-city-panel">
              ...
              <ul className="hero-city-panel-list">
                {['Chamber', 'Technology', 'Real Estate', 'Small Business', 'and many more'].map((tag) => {
                  ...
                  const href = (SUB_CALENDARS_ENABLED && slug[tag as keyof typeof slug]) ? `/texas/houston/${slug[tag as keyof typeof slug]}` : null; // SUB-CAL: hidden while paused
                  return (
...
<section className="features-section">
      ...
      <section className="sa-calendar-section" id="calendar">
        ...
        <EventGate forcedCity="Houston" initialEvents={initialEvents} showMonthCalendar={true} citySlug="houston" />
      </section>
