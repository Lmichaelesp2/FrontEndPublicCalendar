...
import { Star, Plus, Minus, Search, Mail, Briefcase, Users, Clock, ArrowLeft, CalendarDays, Building2 } from 'lucide-react';
    ...
    <div className="sa-page">
      ...
      <section className="hero">
        <div className="hero-inner">
          ...
          <p className="hero-subtext">
            Stop missing the small business events that help you grow.
          </p>
      ...
      <section className="features-section">
        <div className="features-inner">
          ...
          <p className="features-subtitle">We aggregate small business event sources across San Antonio so you don't have to — then deliver the best event opportunities straight to your email every Monday.</p>
        ...
        <div className="value-inner">
          ...
          <div className="value-grid">
            ...
            <div className="value-card">
              ...
              <p>The email and the calendar work together so you always know what's coming up in the small business community.</p>
            </div>
          </div>
        </div>
      </section>
