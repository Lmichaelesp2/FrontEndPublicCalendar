  ...
  return (
    <div className="sa-page">
      ...
      <div className="sa-breadcrumb">
        ...
        <span> &rsaquo; </span>
        <Link to="/texas/san-antonio">San Antonio</Link>
        <span> &rsaquo; </span>
      ...
      <section className="sa-subscribe-section" id="sa-subscribe">
        <div className="sa-subscribe-inner">
          ...
          <p>Get San Antonio networking events delivered to your inbox every Monday morning — just the events worth your time.</p>
