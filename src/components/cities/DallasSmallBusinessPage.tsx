...
function DallasSmallBusinessContent() {
    ...
    <div className="sa-page">
      ...
      <section className="sa-subscribe-section" id="sa-subscribe">
        <div className="sa-subscribe-inner">
          ...
          <p>Get Dallas's best small business events delivered to your inbox every Monday morning. No spam, no fluff — just the events worth your time.</p>
...
export function DallasSmallBusinessPage() {
  return <DallasSmallBusinessContent />;
}
