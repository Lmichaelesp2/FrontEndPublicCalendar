    ...
    <div className="sa-page">
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '780px', margin: '0 auto' }}>
          <p style={{ margin: '0 0 0.5rem', fontSize: '0.7rem', letterSpacing: '0.14em', textTransform: 'uppercase', color: '#c9a84c', fontFamily: 'var(--font-sans)', fontWeight: 700 }}>
            Free Resource
          </p>
          <h2 style={{ margin: '0 0 1.25rem', fontSize: '1.6rem', color: '#ffffff', fontWeight: 600, fontFamily: 'var(--font-serif)', lineHeight: 1.3, letterSpacing: '-0.02em' }}>
            The Event Networking Method
          </h2>
          <p style={{ margin: '0 0 1.25rem', fontSize: '1rem', color: '#b0b8c8', lineHeight: 1.8 }}>
            Most people attend events and hope something happens. The Event Networking Method is a complete system for building a professional network with intention — starting with identifying exactly who you want to know, the organizations they belong to, and the events they're already at. The San Antonio calendar is one of the tools. The method is how you use it.
          </p>
          <div style={{ display: 'flex', gap: '1.5rem', margin: '0 0 1.75rem', flexWrap: 'wrap' }}>
            {['People', 'Content', 'Events', 'Relationships'].map((phase, i) => (
              <div key={phase} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <span style={{ fontSize: '0.7rem', fontWeight: 800, color: '#c9a84c', fontFamily: 'var(--font-sans)', opacity: 0.6 }}>{i + 1}</span>
                <span style={{ fontSize: '0.875rem', fontWeight: 600, color: '#ffffff', fontFamily: 'var(--font-sans)', letterSpacing: '0.02em' }}>{phase}</span>
              </div>
            ))}
          </div>
          <a
