  ...
  return (
    <footer className="footer">
      ...
      <p style={{ marginTop: '0.4rem' }}>
        <Link href="/about">About</Link> &middot; <Link href="/contact">Contact</Link> &middot; <Link href="/privacy">Privacy Policy</Link> &middot; <Link href="/terms">Terms &amp; Conditions</Link> &middot; <Link href="/sponsor">Sponsorship</Link> &middot; <Link href="/submit">Submit Your Event</Link> &middot; <Link href="/account">Manage My Subscriptions</Link>
      </p>
