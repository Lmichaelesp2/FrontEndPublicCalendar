...
export function EventNetworkingMethodSection() {
  return (
    <section className="enm-home-section">
      <div className="enm-home-inner">
        ...
        <div className="enm-home-steps">
          {[
            { num: '1', title: 'Goal', desc: 'What are you trying to accomplish?' },
            { num: '2', title: 'People', desc: 'Who do you want to meet?' },
            { num: '3', title: 'Event', desc: 'Which event are they likely to attend?' },
